...
sumo_cfg = "../data/scenarios/test3/sim.sumocfg"
...
with open(output_csv, mode="w", newline="") as file:
    ...
    writer.writerow(["time", "veh_id", "soc_percent", "is_charging", "station_id"])
...
# Ensure the writer is properly defined and used consistently
...
tree = ET.parse("../data/scenarios/test3/osm.chargingstations.xml")
root = tree.getroot()
...
tree.write("../data/scenarios/test3/osm.chargingstations.xml", encoding="utf-8", xml_declaration=True)
