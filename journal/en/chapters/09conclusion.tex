...
Across five scenario instances both strategies lift the fleet's end-of-day state of charge by roughly three percentage points and cut the share of undersupplied agents by six to eight. Neither beats the other. What decides the outcome is how many stations are added, not the heuristic that picks them, and accessibility stops improving well before full coverage. For the area studied that ceiling sits near 75 stations. The practical value of the workflow is therefore less in ranking sites against each other than in locating the point where further construction stops paying off.
