...
def main():
    ...
    parser.add_argument(
        "--log", 
        default="generated_files/logs/model_log_data.csv",
        help="Path to model_log_data.csv"
    )
    parser.add_argument(
        "--net",
        default="generated_files/osm.net.xml",
    ...
    # Write outputs
    csv_path = "generated_files/logs/charging_suggestions.csv"
    geojson_path = "generated_files/logs/charging_areas.geojson"
    xml_path = "generated_files/generated_charging.add.xml"
